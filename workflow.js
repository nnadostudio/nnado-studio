...
const NNADO_WORKFLOW = {
  ...
  services: {
    ...
    web: {name:'Web Design + Build',priceLabel:'Starting at $1,500',min:1500,max:2500,description:'For a custom, brand-forward, responsive website that is designed, built, and prepared for launch.',addons:['webPage','booking','emailSignup','copyLayout','maintenance','ecommerce','rush']},
